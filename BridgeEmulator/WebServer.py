...
def runHTTP(BIND_IP, HOST_HTTP_PORT, server_class=ThreadingSimpleServer, handler_class=HTTPHandler):
...
def runHTTPS(BIND_IP, HOST_HTTPS_PORT, server_class=ThreadingSimpleServer, handler_class=HTTPHandler):
