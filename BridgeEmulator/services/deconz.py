        ...
        if not getObject("sensors", id):
            ...
            if sensor["modelid"] in motionSensors:
                ...
                if sensor["type"] == "ZHALightLevel":
                    ...
                    bridgeConfig["sensors"][new_sensor_id] = Sensor(lightSensor)
                    ...
                    bridgeConfig["sensors"][new_sensor_id] = Sensor(motion_sensor)
                    new_sensor_id = nextFreeId(bridgeConfig, "sensors")
                ...
                bridgeConfig["sensors"][new_sensor_id] = Sensor(sensor)
